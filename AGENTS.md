...
- Calendar schedule creation supports pre-registering participants for joinable schedules via friend multi-select and manual name input; saved names are shown in `参加中` together with approved participants.
